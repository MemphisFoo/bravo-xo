...
function App() {
  ...
  function fetchProfPhoto(id) {
    fetch(`/current_user_photos?id=${id}`)
      .then(r => r.json())
      .then(photo => {
        setProfileImage(photo.image_url)
	...
	return (
		<BrowserRouter>
			<NavBar className="App" profileImage={profileImage} currentUser={currentUser} handleLogout={handleLogout} isLoggedIn={isLoggedIn} />
			<div>
				<Switch>
					<Route exact path="/">
            ...
            onSearchChange={setSearch}/> */}
					<Route exact path="/shows">
						<Shows profileImage={profileImage} shows={shows} />
					</Route>
