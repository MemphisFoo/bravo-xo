...
function Profile({currentProfile,currentUser}) {
  ...
  return (
    <div className="flex flex-col items-center bg-gradient-to-br from-purple-500 to-pink-500 text-white rounded-lg border shadow-md md:flex-row md:max-w-xl dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
      ...
      <div>
        ...
        <p>Pronouns {currentUser.profile.pronoun.preference}</p>
        <p>Bio: "{currentUser.profile.bio}"</p>
        <p>Sexuality: {currentUser.profile.sexuality.choose}</p>
        <p>Show: {currentUser.profile.show.title}</p>
