...
puts "complete!"
puts "creating shows 📺"
c1 = Category.create(show: "Real Housewives of Atlanta")
c2 = Category.create(show: "Real Housewives of Beverly Hills")
c3 = Category.create(show: "Real Housewives of New York")
c4 = Category.create(show: "Real Housewives of Orange County")
c5 = Category.create(show: "Real Housewives of Salt Lake City")
c6 = Category.create(show: "Vanderpump Rules")
c7 = Category.create(show: "Below Deck")
c8 = Category.create(show: "Below Deck Mediterranean")
c9 = Category.create(show: "Summer House")
c10 = Category.create(show: "Southern Charm")
c11 = Category.create(show: "Married To Medicine")
puts "complete!"

puts "seeding users 🗑"
u1=User.create([{first_name: "Graham", last_name: "Price", profile_photo: "https://thumbs.dreamstime.com/b/child-hammer-12360121.jpg", 
    bio: "Bravo Country, let's ride!", category_id: c1.id, username:"HammerBaby9", email:"hb9@gmail.com", 
...
u2=User.create([{first_name: "Christian", last_name: "Trublet", profile_photo: "http://www.jermainerogers.com/wp-content/uploads/11_foomotor2.jpg", 
    bio: "It's not about the f**king pasta!", category_id: c2.id, username:"MemphisFoo", 
...
u3=User.create([{first_name: "Asia", last_name: "Dillon", profile_photo: "https://i.guim.co.uk/img/media/8cd88a8e30dcf4c4d2a2fb9ad7e4b5fe5fec33b7/0_0_4388_2633/master/4388.jpg?width=1200&height=1200&quality=85&auto=format&fit=crop&s=227ba9f78f03518307b0409e635f92db", 
    bio: "Started from the bottom now we here", category_id: c3.id, username:"TayMay", email:"taylor@masecap.com", 
...
u4=User.create([{first_name: "Lala", last_name: "Kent", profile_photo: "https://www.the-sun.com/wp-content/uploads/sites/6/2022/03/unnamed-1-12.jpg", 
    bio: "It's true what they say about how you lose your partner", category_id: c6.id, username:"GiveThemLala", email:"lala@vdpr.com", 
    sexuality_id: s1.id, pronoun_id: p2.id, password:"0ce@N"}])
u5=User.create([{first_name: "Randall", last_name: "Emmet", profile_photo: "https://www.the-sun.com/wp-content/uploads/sites/6/2021/09/KB_COMP_Emmett-Randall-1.jpg", 
    bio: "Fofty, please", category_id: c6.id, username:"RandyMcRandRand", email: "randall@oasis.com", 
...
u6=User.create([{first_name: "Adam", last_name: "Levine", profile_photo: "https://pbs.twimg.com/media/EF-H0FhU8AIlnV7.jpg", 
    bio: "By the time you read this, Behati has probably left me. DEAD serious. 🤷🏻‍♂️", category_id: c9.id, username:"IMayNeedToSeeTheBooty", 
...
u7=User.create([{first_name: "Danica", last_name: "Roem", profile_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/db/2017.07.26_Protest_Trans_Military_Ban%2C_White_House%2C_Washington_DC_USA_7684_%2836056856301%29_%28cropped%29.jpg/220px-2017.07.26_Protest_Trans_Military_Ban%2C_White_House%2C_Washington_DC_USA_7684_%2836056856301%29_%28cropped%29.jpg", 
    bio: "First out transgender person to be elected to the Virgina general assembly.", category_id: c8.id, username:"DelegateDanica", 
...
u8=User.create([{first_name: "Chaz", last_name: "Bono", profile_photo: "https://m.media-amazon.com/images/M/MV5BMDY4YzliNzUtNjVmZC00YmJmLTgwYzEtYjAxOGZiNTJjNjc3XkEyXkFqcGdeQXVyMjQwMDg0Ng@@._V1_.jpg", 
    bio: "🎶Do you believe in love after...🎶 You know what, never mind.", category_id: c8.id, username:"Chazi-B", 
...
u9=User.create([{first_name: "Lisa", last_name: "Trublet", profile_photo: "https://i.pinimg.com/280x280_RS/8a/aa/c3/8aaac31289c00ab555501014642a976d.jpg", 
    bio: "I'm only here because my husband made this app 🙄 I'll block you.", category_id: c2.id, username:"LisaChoc", 
    email: "lisa@gmail.com", sexuality_id: s1.id, pronoun_id: p2.id, password:"waterfall"}])
